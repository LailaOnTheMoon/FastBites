...
<section class="header-section">
    <h1 class="restaurant-name">BiteRush Kitchen</h1>
    <p class="restaurant-subtitle">Gourmet Fast Food & Authentic Flavors</p>
    <p class="restaurant-desc">Experience the perfect blend of speed and quality. Our wood-fired pizzas, juicy burgers, and delectable dishes are crafted with premium ingredients and passion for perfection.</p>
</section>
...
<section class="menu-container">
    ...
    <div class="menu">
        <!-- Menu Item 1 -->
        <div class="menu-item">
            <img src="{{ asset('images/pizza.png') }}" alt="Classic Pizza">
        ...
        <!-- Menu Item 2 -->
        <div class="menu-item">
            <img src="{{ asset('images/beefburger.jpg') }}" alt="Beef Burger">
            <div class="menu-item-info">
        ...
        <!-- Menu Item 3 -->
        <div class="menu-item">
            <img src="{{ asset('images/chicken.png') }}" alt="Crispy Chicken">
            <div class="menu-item-info">
        ...
        <!-- Menu Item 4 -->
        <div class="menu-item">
            <img src="{{ asset('images/salad.jpg') }}" alt="Fresh Salad">
            <div class="menu-item-info">
        ...
        <!-- Menu Item 5 -->
        <div class="menu-item">
            <img src="{{ asset('images/shawarma.jpg') }}" alt="Shawarma">
            <div class="menu-item-info">
                ...
                <div class="menu-item-meta">
                    ...
                    <div class="controls">
                        <div class="select-checkbox">
                            ...
                            <label for="shawarma">Select</label>
                        </div>
                        <div class="quantity-control">
                            <button onclick="decrementQty(this)">−</button>
                            <input type="number" min="1" value="1">
