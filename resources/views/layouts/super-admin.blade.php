...
<head>
    ...
    <title>@yield('title', 'FastBites Super Admin')</title>
...
<body>
    <button class="mobile-menu-toggle" type="button" aria-label="Open menu" aria-controls="superAdminSidebar" aria-expanded="false">
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16v2H4zm0 8h16v2H4zm0-4h16v2H4z" /></svg>
    </button>
    <div class="sidebar-overlay" aria-hidden="true"></div>
    <div class="admin-shell">
        <aside class="admin-sidebar" id="superAdminSidebar">
            <div>
                <div class="brand-block">
                    <div class="sidebar-brand-row">
                        <a href="{{ route('super-admin.dashboard') }}" class="brand-name">FastBites</a>
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="{{ route('super-admin.manage-admins') }}" class="nav-item {{ request()->routeIs('super-admin.manage-admins') ? 'active' : '' }}">
                        <span class="nav-icon">
                    ...
                    <a href="{{ route('super-admin.manage-restaurants') }}" class="nav-item {{ request()->routeIs('super-admin.manage-restaurants') ? 'active' : '' }}">
                        <span class="nav-icon">
                    ...
                    <a href="{{ route('super-admin.user-management') }}" class="nav-item {{ request()->routeIs('super-admin.user-management') ? 'active' : '' }}">
                        <span class="nav-icon">
                            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16 11a4 4 0 1 0-4-4 4 4 0 0 0 4 4m-8 1a3 3 0 1 0-3-3 3 3 0 0 0 3 3m0 2c-2.33 0-7 1.17-7 3.5V20h9v-2.5c0-1.09.8-2.04 2.12-2.77A14.45 14.45 0 0 0 8 14m8 0c-2.33 0-7 1.17-7 3.5V20h14v-2.5c0-2.33-4.67-3.5-7-3.5" /></svg>
                        </span>
                        <span>User Management</span>
                    </a>
                    <a href="{{ route('super-admin.system-reports') }}" class="nav-item {{ request()->routeIs('super-admin.system-reports') ? 'active' : '' }}">
                        <span class="nav-icon">
                    ...
                    <a href="{{ route('super-admin.settings') }}" class="nav-item {{ request()->routeIs('super-admin.settings') ? 'active' : '' }}">
                        <span class="nav-icon">
