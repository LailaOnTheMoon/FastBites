...
<nav x-data="{ open: false, userDropdownOpen: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">{{ $navName }}</div>
                <div class="font-medium text-sm text-gray-500">{{ $navEmail }}</div>
            </div>
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button
                        type="submit"
                        class="block w-full px-4 py-2 text-left text-base font-medium text-red-600 hover:bg-red-50"
                    >
                        {{ __('Log Out') }}
                    </button>
                </form>
