...
<head>
    ...
    <title>@yield('title', 'FastBites User Management')</title>
...
<body>
    <button class="mobile-menu-toggle" type="button" aria-label="Open menu" aria-controls="userManagementSidebar" aria-expanded="false">
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16v2H4zm0 8h16v2H4zm0-4h16v2H4z" /></svg>
    </button>
    <div class="sidebar-overlay" aria-hidden="true"></div>
    <div class="admin-shell">
        <aside class="admin-sidebar" id="userManagementSidebar">
            <div>
                <div class="brand-block">
                    <div class="sidebar-brand-row">
                        <a href="{{ route('user-management.dashboard') }}" class="brand-name">FastBites</a>
                    ...
                    <p class="brand-subtitle">User Management Panel</p>
                </div>

                <nav class="sidebar-nav">
                    <a href="{{ route('user-management.dashboard') }}" class="nav-item {{ request()->routeIs('user-management.dashboard') ? 'active' : '' }}">
                        <span class="nav-icon">
                    ...
                    <a href="{{ route('user-management.all-users') }}" class="nav-item {{ request()->routeIs('user-management.all-users') ? 'active' : '' }}">
                        <span class="nav-icon">
                    ...
                    <a href="{{ route('user-management.user-profiles') }}" class="nav-item {{ request()->routeIs('user-management.user-profiles') ? 'active' : '' }}">
                        <span class="nav-icon">
                            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a5 5 0 0 1 5 5c0 1.63-.78 3.08-2 4l3 3v2h-2l-3-3a4.98 4.98 0 0 1-6-8 5 5 0 0 1 5-3m0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6M4 20a6 6 0 0 1 12 0H4z" /></svg>
                        </span>
                        <span>User Profiles</span>
                    </a>
                    <a href="{{ route('user-management.user-reports') }}" class="nav-item {{ request()->routeIs('user-management.user-reports') ? 'active' : '' }}">
                        <span class="nav-icon">
                    ...
                    <a href="{{ route('user-management.settings') }}" class="nav-item {{ request()->routeIs('user-management.settings') ? 'active' : '' }}">
                        <span class="nav-icon">
